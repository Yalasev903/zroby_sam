        ...
        <div class="blog-item__content">
            <div class="blog-item__top flx-align">
                ...
                <div class="blog-item__date font-14 flx-align gap-2 font-14 text-heading fw-500">
                    <span class="icon"><img src="assets/images/icons/calendar.svg" alt=""></span>
...
<!-- ==================== Footer End Here ==================== -->
    ...
    <!-- Jquery js -->
    <script src="assets/news/assets/js/jquery-3.7.1.min.js"></script>
    <!-- Bootstrap Bundle Js -->
    <script src="assets/news/assets/js/boostrap.bundle.min.js"></script>
    <!-- CountDown -->
    <script src="assets/news/assets/js/countdown.js"></script>
    <!-- counter up -->
    <script src="assets/news/assets/js/counterup.min.js"></script>
    <!-- Slick js -->
    <script src="assets/news/assets/js/slick.min.js"></script>
    <!-- magnific popup -->
    <script src="assets/news/assets/js/jquery.magnific-popup.js"></script>
    <!-- apex chart -->
    <script src="assets/news/assets/js/apexchart.js"></script>

    <!-- main js -->
    <script src="assets/news/assets/js/main.js"></script>
