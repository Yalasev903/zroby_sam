<div class="pt-0 lg:p-8 bg-white border-b border-gray-200">
    @php
        // Получаем нужных исполнителей, например, последние 6 записей
        $executors = \App\Models\User::where('role', 'executor')
                        ->orderBy('created_at', 'desc')
                        ->limit(6)
                        ->get();
    @endphp

    {{-- Подключаем только контент-часть без оберток макета --}}
