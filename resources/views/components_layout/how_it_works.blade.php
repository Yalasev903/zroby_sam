                    ...
                    <div class="row items-end">
                        <div class="col col-12 col-md-6" data-custom-animations="true" data-ca-options='{"animationTarget": "p", "ease": "power4.out", "initValues": {"y": "45px", "rotationY" : 65, "opacity" : 0, "transformOrigin": "100% 50% 0px"} , "animations": {"y": "0px", "rotationY" : 0, "opacity" : 1, "transformOrigin": "50% 50% 80px"}}'>
                            <div class="mb-100 mr-90 lg:mr-0 sm:m-0">
                                <h3 class="h4 pt-2 ld-fh-element m-0 inline-block relative">Для замовників:</h3>
                                <p class="text-22 font-medium leading-1/15em mb-1/15em">
                                    <span class="text-blue-400">Створюйте оголошення, описуйте завдання та знаходьте спеціалістів.<br>
                                        Обирайте виконавців, переглядаючи їхні портфоліо та відгуки.</span>
                                </p>
                            </div>
                        </div>
                                        ...
                                        <div class="w-full flex">
                                            <div class="has-bg bg-center bg-cover transition-all py-25 px-35 rounded-10" style="background-image: url('./assets/images/demo/start-hub-2/bg/bg.jpg');">
                                                <div class="ld-fancy-heading relative">
                                                    <h3 class="h4 pt-2 ld-fh-element m-0 inline-block relative">Для виконавців:</h3>
                                                    <h5 class="ld-fh-element mb-0/5em inline-block relative">Реєструйтесь, заповнюйте профіль та додавайте свої послуги.<br>
                                                        Відгукуйтесь на завдання, виконуйте роботу та отримуйте рейтинг.</h5>
                                                </div>
