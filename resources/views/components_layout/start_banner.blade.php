                    ...
                    <div class="col col-12 text-center" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element", "ease": "power4.out", "initValues": {"y": "30px", "rotationY" : 40, "opacity" : 0} , "animations": {"y": "0px", "rotationY" : 0, "opacity" : 1}}'>
                        <div class="relative flex flex-col text-center">
                            <div class="w-auto absolute module-shape-1 -top-5percent -left-10percent sm:hidden" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom", "end": "bottom+=0px top"}' data-parallax-from='{"x": "100px", "y": "175px", "rotationZ" : -50}' data-parallax-to='{"x": "15px", "y": "-60px", "rotationZ" : 20}'>
                                <img class="animation-element" width="179" height="120" src="./assets/images/demo/start-hub-2/3D/Image-752.png" alt="3D comment">
                            </div>
                            <div class="w-auto z-1 absolute module-shape-2 top-40percent -left-20percent" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom", "end": "bottom+=0px top"}' data-parallax-from='{"y": "-114px", "scaleX" : 0.8, "scaleY" : 0.8}' data-parallax-to='{"y": "115px", "scaleX" : 1.3, "scaleY" : 1.3}'>
                                <img class="animation-element" width="210" height="290" src="./assets/images/demo/start-hub-2/3D/3.png" alt="3D person">
                            </div>
                            <div class="w-auto absolute module-shape-3 top5percent -right20percent  sm:hidden" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom", "end": "bottom+=0px top"}' data-parallax-from='{"y": "245px", "scaleX" : 1, "scaleY" : 1, "rotationZ" : -70}' data-parallax-to='{"y": "-65px", "scaleX" : 1.1, "scaleY" : 1.1, "rotationZ" : 25}'>
                                <img class="animation-element" width="187" height="196" src="./assets/images/demo/start-hub-2/3D/1.png" alt="3D cloud">
                            </div>
                            <div class="w-auto z-1 absolute module-shape-4 top-45percent " data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom", "end": "bottom+=0px top"}' data-parallax-from='{"y": "-50px", "scaleX" : 1, "scaleY" : 1, "rotationZ" : 78}' data-parallax-to='{"y": "120px", "scaleX" : 1.1, "scaleY" : 1.1, "rotationZ" : -39}'>
                                <img class="animation-element" width="150" height="164" src="./assets/images/demo/start-hub-2/3D/4.png" alt="3D hand">
                            </div>
                            <div class="relative z-2">
                                <div class="ld-fancy-heading relative animation-element">
                                    <h1 class="ld-fh-element relative lqd-highlight-custom lqd-highlight-custom-2 mb-0/35em text-white text-70" data-text-rotator="true" data-inview="true" data-transition-delay="true" data-delay-options='{"elements": ".lqd-highlight-inner", "delayType": "transition"}'>
                                        <span>Pеєструйся</span>
                                        <mark class="lqd-highlight">
                                            <span class="lqd-highlight-txt">у нашому додатку</span>
                                        ...
                                        <span class="txt-rotate-keywords">
                                            <span class="txt-rotate-keyword active">
                                                <span>як Виконавець чи Замовник</span>
                                            </span>
                                            <span class="txt-rotate-keyword">
                                                <span>та отримуйте доступ!</span>
                                            </span>
                                            <span class="txt-rotate-keyword">
                                                <span>до оголошень!</span>
                                            </span>
                                        </span>
                                    </h1>
                                   </div>
                                ...
                                <div class="mb-45 animation-element">
                                    <p class="m-0">
                                        ...
                                        <span>&nbsp; &nbsp;</span>
                                        <span class="text-12">Спробуйте безкоштовно. Кредитна картка не потрібна.</span>
                                    </p>
                                </div>
                            </div>
