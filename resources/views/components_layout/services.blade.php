							...
							<div class="row justify-center">
								<div class="col col-12 col-md-10 col-lg-9 col-xl-7 mb-25 text-center px-70 sm:px-0">
									<div class="mb-20 ld-fancy-heading relative">
										<h6 class="ld-fh-element m-0 inline-block relative label text-10 tracking-1 uppercase font-bold text-blue-500 bg-blue-200 trackink-1px py-5 px-15 rounded-100">Послуги</h6>
									</div>
									<div class="ld-fancy-heading relative">
										<h2 class="ld-fh-element mb-0/5em inline-block relative">Які послуги доступні в нашому додатку?</h2>
									</div>
								</div>
								...
								<div class="col col-12 col-md-6 p-15">
									<div class="iconbox flex flex-grow-1 relative iconbox-heading-arrow-onhover box-shadow-bottom bg-white rounded-16 pt-35 pr-65 pb-40 pl-50 mb-15 mr-10 lg:m-0">
										...
										<div class="contents">
											...
											<p>✔ Будівництво будинків, квартир, офісів<br>
                                                ✔ Ремонт житлових та комерційних приміщень<br>
                                                ✔ Дизайн інтер’єру, перепланування<br>
                                                ✔ Встановлення вікон і дверей<br>
                                                ✔ Малярні та штукатурні роботи<br>
                                                ✔ Монтаж гіпсокартону, натяжні стелі<br>
                                                ✔ Сантехнічні роботи, встановлення водопостачання<br>
                                                ✔ Електромонтажні роботи</p>
										</div>
									</div>
								</div>
								<div class="col col-12 col-md-6 p-15">
									<div class="iconbox flex flex-grow-1 relative iconbox-heading-arrow-onhover box-shadow-bottom bg-white rounded-16 pt-35 pr-65 pb-40 pl-50 mb-15 ml-10 lg:m-0">
										...
										<div class="contents">
											<h3 class="text-20 lqd-iconbox-heading">
												<span>💆‍♀️ Краса та здоров’я:</span>
												<svg class="inline-block" xmlns="http://www.w3.org/2000/svg" width="12" height="32" viewbox="0 0 12 32">
													<path fill="currentColor" d="M8.375 16L.437 8.062C-.125 7.5-.125 6.5.438 5.938s1.563-.563 2.126 0l9 9c.562.562.624 1.5.062 2.062l-9.063 9.063c-.312.312-.687.437-1.062.437s-.75-.125-1.063-.438c-.562-.562-.562-1.562 0-2.125z"></path>
												</svg>
											</h3>
											<p>✔ Перукарські послуги (стрижки, фарбування)<br>
                                                ✔ Візаж та макіяж<br>
                                                ✔ Манікюр, педикюр<br>
                                                ✔ Косметологічні процедури<br>
                                                ✔ Масаж, догляд за тілом<br>
                                                ✔ Послуги барбершопу</p>
										</div>
									</div>
								</div>
								<div class="col col-12 col-md-6 p-15">
									<div class="iconbox flex flex-grow-1 relative iconbox-heading-arrow-onhover box-shadow-bottom bg-white rounded-16 pt-35 pr-65 pb-40 pl-50 mb-15 mr-10 lg:m-0">
										...
										<div class="contents">
											<h3 class="text-20 lqd-iconbox-heading">
												<span>🏡 Домашні послуги:</span>
												<svg class="inline-block" xmlns="http://www.w3.org/2000/svg" width="12" height="32" viewbox="0 0 12 32">
													<path fill="currentColor" d="M8.375 16L.437 8.062C-.125 7.5-.125 6.5.438 5.938s1.563-.563 2.126 0l9 9c.562.562.624 1.5.062 2.062l-9.063 9.063c-.312.312-.687.437-1.062.437s-.75-.125-1.063-.438c-.562-.562-.562-1.562 0-2.125z"></path>
												</svg>
											</h3>
											<p>✔ Прибирання квартир, будинків та офісів<br>
                                                ✔ Догляд за дітьми (няні)<br>
                                                ✔ Догляд за літніми людьми<br>
                                                ✔ Вигул собак, догляд за тваринами<br>
                                                ✔ Прання та прасування</p>
										</div>
									</div>
								</div>
								<div class="col col-12 col-md-6 p-15">
									<div class="iconbox flex flex-grow-1 relative iconbox-heading-arrow-onhover box-shadow-bottom relative bg-white rounded-16 pt-35 pr-65 pb-40 pl-50 mb-15 ml-10 lg:m-0">
										...
										<div class="contents">
											<h3 class="text-20 lqd-iconbox-heading">
												<span>🚚 Транспорт та перевезення:</span>
												<svg class="inline-block" xmlns="http://www.w3.org/2000/svg" width="12" height="32" viewbox="0 0 12 32">
													<path fill="currentColor" d="M8.375 16L.437 8.062C-.125 7.5-.125 6.5.438 5.938s1.563-.563 2.126 0l9 9c.562.562.624 1.5.062 2.062l-9.063 9.063c-.312.312-.687.437-1.062.437s-.75-.125-1.063-.438c-.562-.562-.562-1.562 0-2.125z"></path>
												</svg>
											</h3>
											<p>✔ Вантажоперевезення<br>
                                                ✔ Послуги таксі<br>
                                                ✔ Перевезення меблів, техніки<br>
								...
								<div class="col col-12 col-md-6 p-15">
									<div class="iconbox flex flex-grow-1 relative iconbox-heading-arrow-onhover box-shadow-bottom bg-white rounded-16 pt-35 pr-65 pb-40 pl-50 mb-15 mr-10 lg:m-0">
										...
										<div class="contents">
											<h3 class="text-20 lqd-iconbox-heading">
												<span>🎓 Освіта та репетиторство:</span>
												<svg class="inline-block" xmlns="http://www.w3.org/2000/svg" width="12" height="32" viewbox="0 0 12 32">
													<path fill="currentColor" d="M8.375 16L.437 8.062C-.125 7.5-.125 6.5.438 5.938s1.563-.563 2.126 0l9 9c.562.562.624 1.5.062 2.062l-9.063 9.063c-.312.312-.687.437-1.062.437s-.75-.125-1.063-.438c-.562-.562-.562-1.562 0-2.125z"></path>
												</svg>
											</h3>
											<p>✔ Репетиторство з математики, фізики, мов<br>
                                                ✔ Онлайн-курси, навчальні консультації<br>
                                                ✔ Музичні уроки (фортепіано, гітара, вокал)</p>
										</div>
									</div>
								</div>
								<div class="col col-12 col-md-6 p-15">
									<div class="iconbox flex flex-grow-1 relative iconbox-heading-arrow-onhover box-shadow-bottom bg-white rounded-16 pt-35 pr-65 pb-40 pl-50 mb-15 ml-10 lg:m-0">
										...
										<div class="contents">
											...
											<p>✔ Фото- та відеозйомка<br>
                                                ✔ Дизайн, графіка, логотипи<br>
                                                ✔ Ремонт техніки (телефони, ноутбуки, побутова техніка)<br>
                                                ✔ IT-послуги (створення сайтів, налаштування ПЗ)<br>
                                                ✔ Юридичні послуги та консультації</p>
										</div>
									</div>
								</div>
                            </div>
