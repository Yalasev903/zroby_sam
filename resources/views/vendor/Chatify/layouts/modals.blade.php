...
<div class="app-modal" data-name="delete">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="delete" data-modal='0'>
            <div class="app-modal-header">Ви впевнені, що хочете це видалити?</div>
            <div class="app-modal-body">Цю дію не можна скасувати</div>
            <div class="app-modal-footer">
                <a href="javascript:void(0)" class="app-btn cancel">Скасувати</a>
                <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Видалити</a>
            </div>
        </div>
    </div>
</div>
